...
public class ItemController {
    ...
    public String itemNew(@Valid ItemFormDto itemFormDto, BindingResult bindingResult,
        ...
        boolean noFileProvided = (itemImgFileList == null || itemImgFileList.isEmpty())
                || itemImgFileList.stream().allMatch(MultipartFile::isEmpty);

        if (noFileProvided && itemFormDto.getId() == null) {
